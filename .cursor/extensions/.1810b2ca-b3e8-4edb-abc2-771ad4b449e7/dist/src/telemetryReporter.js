...
class TelemetryReporter {
    ...
    sendTelemetryEvent(event) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.userOptIn) {
                yield (0, checkpoint_client_1.check)(Object.assign(Object.assign({}, event), { product: this.product, version: this.version, project_hash: yield (0, hashes_1.getProjectHash)() }));
            }
        });
    }
    updateUserOptIn() {
