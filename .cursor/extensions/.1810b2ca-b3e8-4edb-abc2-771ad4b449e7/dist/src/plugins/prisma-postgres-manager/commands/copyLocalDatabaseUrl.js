...
function copyLocalDatabaseUrl(ppgRepository, args) {
    return __awaiter(this, void 0, void 0, function* () {
        const { name } = PrismaPostgresRepository_1.LocalDatabaseSchema.parse(args);
        const url = yield ppgRepository.getLocalDatabaseConnectionString({ name });
        yield vscode_1.env.clipboard.writeText(url);
        void vscode_1.window.showInformationMessage(`PPg Dev URL copied to your clipboard!`);
    });
}
function copyLocalDatabaseUrlSafely(ppgRepository, args) {
    return __awaiter(this, void 0, void 0, function* () {
